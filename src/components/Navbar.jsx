  ...
  return (
    <nav className="bg-slate-700 text-white px-5">
        ...
        >
          ...
          <button className="relative flex items-center gap-2 px-8 py-2 border-4 border-transparent text-[16px] bg-transparent rounded-full font-semibold text-green-500 shadow-[0_0_0_2px_rgba(0,255,0,1)] overflow-hidden cursor-pointer transition-all duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] hover:shadow-[0_0_0_12px_transparent] hover:text-green-400 hover:rounded-lg active:scale-95">
      <ArrowRight className="absolute w-6 fill-current right-4 transition-all duration-800 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:right-[-25%]" />
      <span className="relative z-10 translate-x-[-12px] transition-all duration-800 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:translate-x-[12px]">
        Book Now
      </span>
